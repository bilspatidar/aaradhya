  ...
  <div class="col-12 grid-margin collapse show" id="collapseExample">
    <div class="card">
      <div class="card-body">
        ...
        <form class="form-sample" id="crudFormAddApiData" action="<?php echo API_DOMAIN; ?>api/documentcategory/document_category_add/add" method="POST">
...
<div class="row">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/documentcategory/document_category_list/" id="list_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/documentcategory/document_category/" id="delete_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/documentcategory/document_category_details/" id="show_endpoint">
  <input type="hidden" value="admin/master/document_category_edit" id="edit_page_name">
